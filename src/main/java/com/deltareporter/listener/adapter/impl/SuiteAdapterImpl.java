  ...
  implements SuiteAdapter
{
  ...
  public String[] getSuiteDependsOnMethods() {
    ...
    String[] allDependentMethods = this.suite.getAllMethods().stream().map(ITestNGMethod::getMethodsDependedUpon).reduce(ArrayUtils.EMPTY_STRING_ARRAY, ArrayUtils::addAll);
