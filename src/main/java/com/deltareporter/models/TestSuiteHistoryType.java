...
public class TestSuiteHistoryType extends AbstractType {
  ...
  public TestSuiteHistoryType(String name, String test_type, String start_datetime, Integer test_run_id) {
    this.name = name;
  ...
  public TestSuiteHistoryType(Integer test_suite_history_id, String end_datetime, String test_suite_status) {
    this.test_suite_history_id = test_suite_history_id;
